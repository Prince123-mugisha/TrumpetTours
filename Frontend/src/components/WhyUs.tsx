      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-white border border-gray-200 p-6 shadow-sm">
            ...
            <div className="mt-4 inline-flex text-xs px-3 py-1 rounded-full bg-safari-gold/10 border border-safari-gold/30 text-safari-darker">15+ Awards</div>
          </Card>
          ...
          <Card className="bg-white border border-gray-200 p-6 shadow-sm">
            ...
            <div className="mt-4 inline-flex text-xs px-3 py-1 rounded-full bg-safari-gold/10 border border-safari-gold/30 text-safari-darker">25+ Expert Guides</div>
          </Card>
          ...
          <Card className="bg-white border border-gray-200 p-6 shadow-sm">
            ...
            <div className="mt-4 inline-flex text-xs px-3 py-1 rounded-full bg-safari-gold/10 border border-safari-gold/30 text-safari-darker">100+ Partners</div>
          </Card>
          ...
          <Card className="bg-white border border-gray-200 p-6 shadow-sm">
            ...
            <div className="mt-4 inline-flex text-xs px-3 py-1 rounded-full bg-safari-gold/10 border border-safari-gold/30 text-safari-darker">100% Coverage</div>
          </Card>
        </div>

        {/* Contact CTA */}
        <div className="mt-16 flex items-center justify-center gap-4 flex-wrap">
          <Button size="lg" className="bg-safari-gold text-safari-darker hover:bg-safari-gold/90 font-semibold">
