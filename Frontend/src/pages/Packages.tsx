      ...
      <section className="relative flex items-center justify-center min-h-screen overflow-hidden pt-28 md:pt-32">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-white/90 text-lg">
            Discover our carefully curated tour packages designed to showcase the best of East Africa's 
            natural wonders, wildlife encounters, and cultural experiences. Each journey is thoughtfully 
            planned to create lasting memories.
          </p>
